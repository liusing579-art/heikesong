const GAME_DATA = {
  ...
  timeline: [
    ...
    { type: "text", character: "wang",
      ...
      background: "办公室背景图.webp",
      images: [
        { src: "惊慌wang.webp", class: "char-left-standalone" }
      ] },
    ...
    { type: "text", character: "wang",
      ...
      background: "宿舍背景图.webp",
      images: [
        { src: "绑架图.webp", class: "char-center" }
      ] },
